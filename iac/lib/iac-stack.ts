...
export class IacStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const alternativeDomain =
            process.env.ALTERNATIVE_DOMAIN_NAME ||
            "vite_react_template.devmaua.com";
        const hostedZoneIdValue =
            process.env.HOSTED_ZONE_ID || "Z1UJRXOUMOOFQ8";
        const projectName =
            process.env.PROJECT_NAME || "ViteReactTemplateFront";
        ...
        new cdk.CfnOutput(
            this,
            projectName + "DistributionDomainName-" + stage,
            {
